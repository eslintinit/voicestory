...
export const messages = queryField('messages', {
  ...
  resolve: async (_, { communityUrl, channelUrl }, ctx) => {
...
/*         lastVisitDate || (channelsInfo[0] && channelsInfo[0].lastUpdateAt) */
/*       lastReadedMessage = await ctx.prisma.message.findMany({ */
/*         where: { */
/*           channel: { url: channelUrl }, */
/*           OR: [ */
/*             { createdAt: { equals: lastUpdateDate } }, */
/*             { createdAt: { lt: lastUpdateDate } }, */
/*           ], */
/*         }, */
/*         last: 1, */
/*       }) */
...
/*       cursorId || */
/*       (lastReadedMessage && lastReadedMessage[0] && lastReadedMessage[0].id) */
